...
#------------------------- Declarations -------------------------------------------------------
    ...
    final_results_dns=[]
    final_results=[]
    #Provide a directory to store logs
    xls_dir = ".../Automate IR/Automate-Incident-Response/excel_logs"
    ...
    #Provide a directory to store processed logs
    out_dir = "/Automate-Incident-Response/CSV Results"
    output_excel_http = "/Automate-Incident-Response/CSV Results/output_http.xlsx"
    output_excel_dns = "/Automate-Incident-Response/CSV Results/output_dns.xlsx"
...
#---------------- Elastic Query Builder Code snippet ------------------------------------------
    excel_file_path_fp_domains = "/Automate-Incident-Response/false_positive_domains.xlsx"
