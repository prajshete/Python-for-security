...
#@app.command()
def get_dns_network_logs(index_name, timestamp: str, fp_domain_query):
            ...
            "query": {
                "bool": {
                    ...
                    "must_not": [
                        ...
                        {"query_string": {"query": fp_domain_query}},
...
#@app.command()
def get_http_network_logs(index_name, timestamp: str, fp_domain_query):
    # Connect to Elasticsearch
    try:
        # Replace with your actual API key
        api_key = "T19Lb0taQUJueTBzSkozRWo4enI6TDVfZlVIcEpUQWU1WVo3TTVOOWM1Zw=="
...
#=======================================================================
    ...
    logs_http = get_http_network_logs('.ds-logs-endpoint.events.network-default*', timestamp, es_query_json)
    if logs_http:
    ...
    logs_dns = get_dns_network_logs('.ds-logs-endpoint.events.network-default*',timestamp, es_query_json)
    if logs_dns:
        # Convert logs to pandas DataFrame
